        ...
        <div className='flex flex-col md:flex-row justify-center mx-auto py-16 px-8 sm:py-12 sm:px-6 lg:min-w-[56rem] lg:px-8 h-[calc(100vh-88px)]'>
          <div className='flex-1 w-full bg-white text-black text-center xl:pt-[1rem] xxs:py-[2rem] flex flex-col justify-between'>
            <div className='flex w-[100%] flex-col justify-between'>
              <h1 className='text-[1.25rem] pt-4 md:text-[1.5rem] lg:text-6xl md:mt-5 font-bold'>Vote For Party</h1>
              ...
              <p className='w-[60%] m-auto mt-[3rem] flex'>
                ...
                the national parliament and state assemblies. In addition, some countries have a local government as
                well as a senate and a president. All elected officials must take your position seriously and fulfill
                your duties to the people. Failure to do so would undermine the democratic process itself.
              </p>
            </div>
          ...
          <div className='flex-1 w-[100%] bg-white text-black text-center xl:pt-[1rem] xxs:py-[2rem] flex flex-col justify-between border-l-slate-400'>
            <div className='flex w-[100%] flex-col justify-between'>
              <h1 className='text-[1.25rem] pt-4 md:text-[1.5rem] lg:text-6xl md:mt-5 font-bold'>Vote For MPS</h1>

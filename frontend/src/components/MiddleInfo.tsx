  ...
  return (
    ...
    >
      <div className='p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mx-[2rem] my-[5rem]'>
        ...
        <p className='mb-3 font-normal text-gray-500 dark:text-gray-400'>Go to this Thairath website now</p>
        <a
      ...
      <div className='p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 mx-[2rem] my-[5rem]'>
        ...
        <p className='mb-3 font-normal text-gray-700 dark:text-gray-400'>
          On November 25, 65, reporters reported that Mr. Chaiwut Thanakmanusorn, Minister of DES, and a list of MPs
          Palang Pracharath Party has decided to submit a resignation letter from a member of the House of
          Representatives By making a letter to the chairman of the House signed on 24 November 2022.
        </p>
        <a
